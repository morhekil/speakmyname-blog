...
<code>$ git submodule add git://github.com/morhekil/factory_haml_rspec_scaffold.git vendor/plugins/factory_haml_rspec_scaffold</code>

And just use it instead of those dull old Rails scaffolds:

<code>$ ./script/generate factory_haml_rspec_scaffold Invoice amount:float info:string</code>
